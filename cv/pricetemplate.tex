...
%linkedin
$if(linkedin)$\faicon{linkedin} \hspace{1 mm} \href{https://www.linkedin.com/in/$linkedin$}{$linkedin$}$endif$
%scholar
$if(scholar)$\faicon{google} \hspace{1 mm} \href{https://scholar.google.com/citations?user=$scholar$}{$scholar$}$endif$%
%orcid
$if(orcid)$\faicon{openid} \hspace{1 mm} \href{https://orcid.org/$orcid$}{$orcid$}$endif$%
%website
